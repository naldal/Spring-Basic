...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		ClassPathXmlApplicationContext ctx =
				new ClassPathXmlApplicationContext("co/kr/softcampus/config/beans.xml");
		...
		TestBean t5 = new TestBean(200, 22, "안녕하세요");
		t5.printData();
		
		System.out.println("===============================================");
		
//		TestBean t6 = new TestBean("반갑습니다", 300, 33.33); //자바에서 생성자타입의 순서가 완벽 일치해야함
//		t6.printData();
